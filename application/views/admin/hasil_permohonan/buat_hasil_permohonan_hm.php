<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Pembuatan Surat Hasil Permohonan HM</h2>
    ...
    <div class="col-12 col-xl-12">
        <div class="card border-primary">
            <div class="card-header bg-primary shadow-sm">
                <h2 class="text-light"><i class="fas fa-file-import"></i> Pembuatan Surat Hasil Permohonan HM (HAK MILIK)</h2>
            </div>
            <div class="card-body bg-white border-primary shadow-sm mb-4">
                <form action="<?php echo base_url() ?>admin/hasil_permohonan/kirim" method="POST" enctype="multipart/form-data">
                    ...
                    Akta Jual Beli Tanah : <a href="<?php echo base_url() . "uploads/permohonan/hm/" . $permohonan['akta_jb'] ?>" target="_blank" rel="nofollow" title="link">Lihat</a><br>
                    KTP : <a href="<?php echo base_url() . "uploads/permohonan/hm/" . $permohonan['ktp'] ?>" target="_blank" rel="nofollow" title="link">Lihat</a><br>
                    Kartu Keluarga : <a href="<?php echo base_url() . "uploads/permohonan/hm/" . $permohonan['kk'] ?>" target="_blank" rel="nofollow" title="link">Lihat</a><br>
                    Girik : <a href="<?php echo base_url() . "uploads/permohonan/hm/" . $permohonan['girik'] ?>" target="_blank" rel="nofollow" title="link">Lihat</a><br>
                    Surat Pernyataan Bebas Sengketa : <a href="<?php echo base_url() . "uploads/permohonan/hm/" . $permohonan['surat_bebas_sengketa'] ?>" target="_blank" rel="nofollow" title="link">Lihat</a><br>
                    Surat Keterangan Riwayat tanah : <a href="<?php echo base_url() . "uploads/permohonan/hm/" . $permohonan['surat_riwayat_tanah'] ?>" target="_blank" rel="nofollow" title="link">Lihat</a><br>
