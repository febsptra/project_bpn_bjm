<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4"> <i class="fas fa-file-import"></i> Data Permohonan HGB (Hak Guna Bangunan)</h2>
        <p class="mb-0">Berikut Data pengajuan surat permohonan Hak Guna Bangunan.</p>
    </div>
            ...
            <div class="card-body bg-white shadow-sm mb-4">
                <div class="tab-content" id="tabcontent1">
                    <div class="tab-pane fade show active" id="tabs-text-1" role="tabpanel" aria-labelledby="tabs-text-1-tab">
                        <h2 class="h5"><i class="fas fa-file-alt"></i> Pengajuan Permohonan HGB (Hak Guna Bangunan)</h2>
                        <br>
                                    ...
                                    foreach ($permohonan_hgb as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-sm" href="<?php echo base_url() . "admin/permohonan/data_hgb/verifikasi/" . $row->no ?>"><i class="fas fa-check"></i> Verifikasi</a>
                                                <a class="btn btn-danger btn-sm" href="<?php echo base_url() . "report/surat_hgb/index/" . $row->no ?>"><i class="fas fa-print"></i> Cetak</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                            </table>
                    ...
                    <div class="tab-pane fade" id="tabs-text-2" role="tabpanel" aria-labelledby="tabs-text-2-tab">
                        <h2 class="h5"><i class="fas fa-clock"></i> Pengajuan Permohonan HGB (Hak Guna Bangunan).</h2>
                        <small class="text-danger">*yang sudah diverifikasi & Sedang/Akan Proses Pengukuran.</small>
                        <br><br>
                        <div class="table-responsive">
                            <table id="example2" class="table table-hovered" style="width:100%">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($permohonan_hgb_diverifikasi as $row) : ?>
                                        <tr>
                                            <td>
                                                <div class="text-center"><?php echo $row->no_permohonan ?></div>
                                            </td>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-light btn-sm" data-toggle="modal" data-target="#detail-hgb<?php echo $row->no ?>"><i class="fas fa-info"></i> Detail</button>
                                                <a class="btn btn-primary btn-sm" href="<?php echo base_url() . "admin/pengukuran/pengukuran/pengukuran_hgb/" . $row->no ?>"><i class="fas fa-plus-circle"></i> Buat Surat Pengukuran</a>
                                                <a class="btn btn-danger btn-sm" href="<?php echo base_url() . "report/surat_hgb/index/" . $row->no ?>"><i class="fas fa-print"></i> Cetak</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                    ...
                    <div class="tab-pane fade" id="tabs-text-3" role="tabpanel" aria-labelledby="tabs-text-3-tab">
                        <h2 class="h5"><i class="fas fa-check"></i> Pengajuan Permohonan HGB (Hak Guna Bangunan).</h2>
                        ...
                        <div class="table-responsive">
                            <table id="example3" class="table table-hovered" style="width:100%">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($permohonan_hgb_selesai as $row) : ?>
                                        <tr>
                                            <td>
                                                <div class="text-center"><?php echo $row->no_permohonan ?></div>
                                            </td>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Detail Permohonan</h6>
...
<?php foreach ($permohonan_hgb_diverifikasi as $row) : ?>
    <div class="modal fade" id="detail-hgb<?php echo $row->no ?>" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Detail Permohonan</h6>
...
<?php foreach ($permohonan_hgb_selesai as $row) : ?>
    <div class="modal fade" id="detail-hgb<?php echo $row->no ?>" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="cetak" tabindex="-1" role="dialog" aria-labelledby="cetak" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Cetak Data HGB</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <a class="btn btn-primary mb-3" href="<?php echo base_url() . 'report/arsip_hgb'; ?>" target="_blank" rel="nofollow">
                    <i class="fas fa-print"></i> Print Seluruh Data Permohonan HGB</a>
                <br>
                <p>
                    -- Atau --
                </p>
