<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Pengajuan Permohonan HGB</h2>
    ...
    <div class="col-12 col-xl-12">
        <div class="card border-primary">
            <div class="card-header bg-primary shadow-sm">
                <h2 class="text-light"><i class="fas fa-file-import"></i> Pengajuan Permohonan HGB</h2>
            </div>
            <div class="card-body bg-white border-primary shadow-sm mb-4">
                ...
                <?php } else { ?>
                    <form action="<?php echo base_url() ?>permohonan/hgb/kirim" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <input type="hidden" id="no_permohonan" name="no_permohonan" value="HGB/<?php echo random_string('numeric', 4) . '/' . date('d') . '/' . $bln . '/' . date('Y') ?>" readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="formulir_pemohon" class="custom-file-input" id="customFile" required>
                                    <label class="custom-file-label" for="customFile">Formulir Pemohon</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="daftar_perusahaan" class="custom-file-input" id="daftar_perusahaan" required>
                                    <label class="custom-file-label" for="customFile">Daftar Perusahaan</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="surat_izin_penggunaan" class="custom-file-input" id="surat_izin_penggunaan" required>
                                    <label class="custom-file-label" for="customFile">Surat Izin Penggunaan tanah</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="bukti_pemasukan" class="custom-file-input" id="bukti_pemasukan" required>
                                    <label class="custom-file-label" for="customFile">Bukti Pembayaran Uang Pendaftaran</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="surat_bebas_sengketa" class="custom-file-input" id="surat_bebas_sengketa" required>
                                    <label class="custom-file-label" for="customFile">Surat Pernyataan tanah Bebas Sengketa</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="surat_tanah_dikuasai" class="custom-file-input" id="surat_tanah_dikuasai" required>
                                    <label class="custom-file-label" for="customFile">Surat Pernyataan Tanah Dikuasai Secara Fisik</label>
                                </div>
                            </div>
                        </div>
