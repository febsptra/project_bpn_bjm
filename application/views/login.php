...
<head>
    <title>Login BPN Banjarmasin</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="signin-inner mt-3 mt-lg-0 bg-white shadow-soft border border-light rounded p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                ...
                                <p class="text-gray">Silahkan Login untuk mengkases website lebih lanjut.</p>
                            </div>
                            <?php echo $this->session->flashdata('sukses_regis') ?>
                            <?php echo $this->session->flashdata('pesan') ?>
                            <form class="mt-5" method="post" action="<?php echo base_url() ?>auth/masuk">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="far fa-user"></i></span></div>
                                        <input type="text" class="form-control" id="input-email" name="username" id="username" placeholder="Masukan Username" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                    ...
                                    <div class="d-block d-sm-flex justify-content-between align-items-center mt-2">
                                        <div class="form-group form-check mt-3"><input type="checkbox" class="form-check-input" id="exampleCheck1"> <label class="form-check-label form-check-sign-white" for="exampleCheck1">Remember me</label></div>
                                        <div><a href="<?php echo base_url() ?>auth/daftar" class="small text-right">Belum Punya Akun?</a></div>
                                    </div>
                                </div>
                                <div class="mt-3"><button type="submit" class="btn btn-block btn-primary">Login</button></div>
                            </form>
                        </div>
                    </div>
                </div>
